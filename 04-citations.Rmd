...
## Criando conta no GitHub
  ...
  Faça sua conta no site https://github.com! São muitas vantagens para um serviço gratuito, então aproveite! Algumas dicas interessantes na hora de criar sua conta são importantes para o seu username. Por favor, não coloque nomes de bate-papo UOL. Essa é uma conta que será muito útil profissionalmente, então tenha em mente algumas coisas:

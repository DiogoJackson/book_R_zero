...
Esse **c** vem da palavra "combinar" (combine em ingles) mas eu acho mais facil lembrar desse **c** representando a palavra "conjunto". Sempre que voce quiser criar um conjunto de objetos ou valores, coloque esse **c** antes do parenteses. Vírgulas no R servem para separar o código. Então, se você quiser digitar números quebrados, nunca utilize **vírgula**, utilize **ponto**.

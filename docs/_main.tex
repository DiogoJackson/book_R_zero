...
\textless img src=``img/fig\_morcegos.png'' alt=``Texto Alternativo'' style=``width: 200px\textgreater{}
...
Logicamente, para você usar esse livro de forma otimizada, precisará ter o R e RStudio instalados. Nem vou falar sobre a instalação, pois sei que você é capaz de encontrar um tutorial feito por uma criança de 8 anos no YouTube.

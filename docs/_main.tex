...
Uma das funcoes mais importantes do R eh a capacidade de armazenar valores em objetos. Por exemplo, podemos dizer que o numero 1 sera atribuido a letra \textbf{``a''}, e para isso utilizamos o sinal de igual (=). O a agora eh considerado um objeto e ira aparecer na janela de Environment (Figura 2 - janela 3).
...
\tightlist
\item
  Substititua ``aluguel\_semana \textless- 200'' por ``aluguel\_semana \textless- 247.53''
\end{itemize}
